...
Overall AI Discoverability Terminal (AIDI) score of ${evaluationData.overallScore.toFixed(2)}/100 indicates ${evaluationData.overallScore >= 80 ? 'strong' : evaluationData.overallScore >= 60 ? 'moderate' : 'weak'} AI visibility.
...
---
*Report generated by AI Discoverability Terminal*
*For technical support: support@ai-discoverability-terminal.com*
    `.trim()
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              <Link href="/" className="inline-flex items-center text-brand-600 hover:text-brand-700 mb-4">
                ...
                <span className="text-xl font-bold">AI Discoverability Terminal</span>
              </Link>
