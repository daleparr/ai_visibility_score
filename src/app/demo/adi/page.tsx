...
/**
 * ADI Demo Dashboard - Premium AI Discoverability Index Features
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Demo Score Results</CardTitle>
            <CardDescription>Sample ADI evaluation results for TechCorp Demo</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-600 mb-2">85</div>
                <div className="text-sm text-gray-600">Overall ADI Score</div>
                <Badge className="mt-2">Grade B</Badge>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600 mb-2">67th</div>
