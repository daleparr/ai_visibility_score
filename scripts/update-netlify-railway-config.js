...
console.log('--------------------------------------------')
console.log('JWT_SECRET=aidi-jwt-secret-2025-production-32-characters-minimum')
console.log('RAILWAY_JWT_SECRET=aidi-jwt-secret-2025-production-32-characters-minimum')
console.log('')
console.log('Bridge Configuration:')
console.log('-------------------')
console.log('NETLIFY_CALLBACK_URL=https://ai-visibility-score.netlify.app/.netlify/functions/bridge-callback')
console.log('NETLIFY_CALLBACK_SECRET=aidi-callback-secret-2025-production')
console.log('')
